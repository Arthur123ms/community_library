...
function createLoanRespositories(userId, bookId, dueDate){
...
function findAllLoanRepositories() {
    return new Promise((resolve, reject) => {
        db.all(
            `SELECT 
...
function findLoansByIdRepositories(loanId){
    return new Promise ((resolve, reject) => {
        db.get(
...
function deleteLoanRepositories (loanId){
    return new Promise ((resolve, reject) => {
...
export default {
    createLoanRespositories,
    findAllLoanRepositories,
    findLoansByIdRepositories,
    deleteLoanRepositories
}